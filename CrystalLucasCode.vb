...
Sub StockMarket()
       ...
       'Variable for holding the ticker name, the column of interest
        ...
        'Keep track of the location for each ticker name in the summary 
table
     ...
     For i = 2 To LastRow
            ...
            If Cells(i + 1, 1).Value <> Cells(i, 1).Value Then
              ...
              'Ticker name in the summary table
              ...
              'Print the yearly change for each ticker in the summary 
table
              Range("J" & summary_ticker_row).Value = yearly_change

             'Check for the non-divisibilty condition when calculating the 
percent change
    ...
    Next i
        ...
        Cells(1, 17).Value = "Value"
         ...
         For i = 2 To lastrow_summary_table
            ...
            If Cells(i, 11).Value = 
Application.WorksheetFunction.Max(Range("K2:K" & lastrow_summary_table)) 
Then
            ...
            ElseIf Cells(i, 11).Value = 
Application.WorksheetFunction.Min(Range("K2:K" & lastrow_summary_table)) 
Then
            ...
            ElseIf Cells(i, 12).Value = 
Application.WorksheetFunction.Max(Range("L2:L" & lastrow_summary_table)) 
Then
